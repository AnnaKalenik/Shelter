...
export default function carousel() {
    ...
    const getSortArr = () => {
        ...
        // if (window.innerWidth >= '768px' && window.innerWidth < '1280px') {
        //     arr.forEach(item => {
        //         if (item !== arrCardsActive[0] && item !== arrCardsActive[1]) {
        //             arrFilter.push(item);
        //         }
        //     })
        // }
    ...
    CAROUSEL.addEventListener('animationend', (event) => {
        ...
        // if (window.innerWidth >= '768px' && window.innerWidth < '1280px') {
        //     if (event.animationName === 'move-left') {
        //         arrCardsNew = [arrFilter[1], arrFilter[4]];
        //         console.log('New:', arrCardsNew);
        //     } else {
        //         arrCardsNew = [arrFilter[0], arrFilter[3]];
        //         console.log('New:', arrCardsNew);
        //     }
        ...
        // if (window.innerWidth < '768px') {
        //     if (event.animationName === 'move-left') {
        //         arrCardsNew = [arrFilter[randomNumber()]];
        //         console.log('New:', arrCardsNew);
        //     } else {
        //         arrCardsNew = [arrFilter[randomNumber()]];
        //         console.log('New:', arrCardsNew);
        ...
        //     let item = document.createElement('div');
        //     item.className = `wrapper__item wrapper__item_item${1}`;
    
        //     item.innerHTML = `
        //         <img src="${pets[arrCardsNew[0]].img}" alt="${pets[arrCardsNew[0]].name}" class="wrapper__img">
        //         <div class="wrapper__subtitle title">${pets[arrCardsNew[0]].name}</div>
        //         <button class="wrapper__btn btn">Learn more</button>`;
